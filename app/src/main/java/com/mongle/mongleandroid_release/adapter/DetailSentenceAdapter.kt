...
import com.mongle.mongleandroid_release.adapter.viewholder.DetailSentenceViewHolder
import com.mongle.mongleandroid_release.network.data.response.OtherSentence

class DetailSentenceAdapter(var datas: List<OtherSentence>, val context: Context) :
