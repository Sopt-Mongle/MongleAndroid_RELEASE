...
import com.example.mongleandroid_release.activity.ThemeWritingSentenceBookSearchActivity.Companion.theme_book_result


class ThemeSentenceBookSearchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
